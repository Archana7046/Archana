...
resetBtn.onclick = function(){
  ...
  if(newPassIn.value == ''){
    ...
    container.innerHTML='<p class="heading">Password Changed</p> <p class="success">Your Password has been updated! Now get back in driver seat, racers are waiting for you!</p> <p class="reset-pass-btn">JOIN A RACE</p>';
